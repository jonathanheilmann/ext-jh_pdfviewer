# -*- coding: utf-8 -*-
#
# pdf viewer documentation build configuration file, created by
# TYPO3 extension sphinx on Tue, 29 Jul 2014 21:27:38 +0200.
#
...
project = u'pdf viewer'
copyright = u'2014, Jonathan Heilmann'
...
htmlhelp_basename = 'jh_pdfviewerdoc'
...
latex_documents = [
    ('Index', 'jh_pdfviewer.tex', u'pdf viewer',
...
pdf_documents = [
    ('Index', 'jh_pdfviewer', u'pdf viewer',
     u'Jonathan Heilmann'),
]
...
texinfo_documents = [
    ('Index', 'jh_pdfviewer', u'pdf viewer',
     u'Jonathan Heilmann', 'pdf viewer', 'One line description of project.',
     'Miscellaneous'),
]
